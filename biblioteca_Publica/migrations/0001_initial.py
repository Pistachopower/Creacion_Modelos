    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='biblioteca_Publica.cliente')),
            ],
        ),
        migrations.CreateModel(
            name='Libro',
            fields=[
                ...
                ('biblioteca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='biblioteca_Publica.biblioteca')),
            ],
        ),
    ]
